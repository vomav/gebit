...
DROP TABLE IF EXISTS db_TestSubEntity;
DROP TABLE IF EXISTS db_TestEntity;
...
CREATE TABLE db_TestEntity (
  ID VARCHAR(36) NOT NULL,
  testString VARCHAR(64),
  testInt INTEGER,
  PRIMARY KEY(ID)
); 

CREATE TABLE db_TestSubEntity (
  ID VARCHAR(36) NOT NULL,
  testSubString VARCHAR(64),
  testSubInt INTEGER,
  user_ID VARCHAR(36),
...
FROM (db_PartAssignments AS dbPartAssignmenst_0 LEFT JOIN db_Parts AS part_1 ON dbPartAssignmenst_0.part_ID = part_1.ID); 
